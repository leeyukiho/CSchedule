...
const BWU_SECTION_TIMES = [
  ...
  { section: 11, start: '20:30', end: '21:15' },
  { section: 12, start: '21:25', end: '22:10' },
]
...
const BWU_MANAGEMENT_CENTER_SECTION_TIMES = [
  { section: 1, start: '08:00', end: '08:45' },
  { section: 2, start: '08:45', end: '09:30' },
  { section: 3, start: '09:50', end: '10:35' },
  { section: 4, start: '10:35', end: '11:20' },
  { section: 5, start: '14:00', end: '14:45' },
  { section: 6, start: '14:45', end: '15:30' },
  { section: 7, start: '15:50', end: '16:35' },
  { section: 8, start: '16:35', end: '17:20' },
  { section: 9, start: '18:30', end: '19:15' },
  { section: 10, start: '19:15', end: '20:00' },
...
const BWU_SECTION_TIME_PROFILES = [
  ...
  {
    id: 'bwu-management-center',
    name: '经管中心',
    buildingKeywords: ['经管中心', '经济管理中心', '研究生', '实验教学中心', '实验教学楼区', '南北实验楼', '科研楼'],
    sectionTimes: BWU_MANAGEMENT_CENTER_SECTION_TIMES,
  },
  {
    id: 'bwu-pe',
    name: '体育课',
    buildingKeywords: ['体育课', '体育场', '轮滑场', '操场', '体育馆'],
